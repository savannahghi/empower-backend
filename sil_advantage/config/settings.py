...
KEYCLOAK = {
    ...
    # Used to create users and realm roles. Only needed where this deployment
    # onboards organisations itself.
...
""" Email """
SERVER_EMAIL = os.getenv("SERVER_EMAIL", "no-reply@empower.local")
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL")
SYSTEM_ADMIN_EMAIL = os.getenv("USER_EMAIL", "system.admin@empower.local")
