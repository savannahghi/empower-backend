...
.. code-block:: bash
    ...
    sudo rabbitmqctl add_user advantage_uat Sp040w76jGyp4VU7
    sudo rabbitmqctl add_vhost advantage_uat
    sudo rabbitmqctl set_permissions -p advantage_uat advantage_uat ".*" ".*" ".*"
